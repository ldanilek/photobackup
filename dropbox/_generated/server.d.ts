...
export declare const component: {
  oauth: {
    getAccessToken: FunctionReference<
      ...
      string
    >;
    isLinked: FunctionReference<"query", "internal", { identity: string }, any>;
    link: FunctionReference<
      "mutation",
      "internal",
      { csrfToken: string; identity?: string; makeUrl: string },
      { identity: string; url: string }
    >;
    setCsrfUrl: FunctionReference<"query", "internal", {}, string>;
  };
};
type ComponentArgs = {
  CONVEX_SITE: string;
